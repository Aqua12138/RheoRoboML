...
from Wasserstein import ParticlePositionChannel
...
def create_environment_factory(
    ...
    def create_unity_environment(
        ...
        # Create an instance of ParticlePositionChannel
        particle_position_channel = ParticlePositionChannel()

        # Add ParticlePositionChannel to the side_channels list
        side_channels.append(particle_position_channel)
